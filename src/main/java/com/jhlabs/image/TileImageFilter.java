...
/**
 * A filter which tiles an com.jhlabs.image into a lerger one.
 */
public class TileImageFilter extends AbstractBufferedImageOp {
	...
	/**
     * Set the output com.jhlabs.image width.
	...
	/**
     * Get the output com.jhlabs.image width.
     * @return the width
     * @see #setWidth
     */
	public int getWidth() {
	...
	/**
     * Set the output com.jhlabs.image height.
	...
	/**
     * Get the output com.jhlabs.image height.
     * @return the height
     * @see #setHeight
     */
