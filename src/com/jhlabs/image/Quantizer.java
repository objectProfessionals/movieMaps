...
/**
 * The interface for an com.jhlabs.image quantizer. The addColor method is called (repeatedly
 * if necessary) with all the com.jhlabs.image pixels. A color table can then be returned by
