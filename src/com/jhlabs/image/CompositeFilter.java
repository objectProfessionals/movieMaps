...
public class CompositeFilter extends AbstractBufferedImageOp {
	...
	/**
     * Construct a CompositeFilter.
     * @param composite the com.jhlabs.composite to use
     */
     ...
     * Construct a CompositeFilter.
     * @param composite the com.jhlabs.composite to use
     * @param transform a transform for the composited com.jhlabs.image
     */
	...
	/**
     * Get the com.jhlabs.composite.
     * @return the com.jhlabs.composite to use
     * @see #setComposite
     */
