...
/**
 * A filter which performs a perspective distortion on an com.jhlabs.image.
 * Coordinates are treated as if the com.jhlabs.image was a unit square, i.e. the bottom-right corner of the com.jhlabs.image is at (1, 1).
...
public class PerspectiveFilter extends TransformFilter {
	...
	/**
     * Set the new positions of the com.jhlabs.image corners.
     * This is the same as unitSquareToQuad, but the coordinates are in com.jhlabs.image pixels, not relative to the unit square.
     ...
     * by the size of the com.jhlabs.image.
     * @param x0 the new position of the top left corner
     * @param y0 the new position of the top left corner
     * @param x1 the new position of the top right corner
     * @param y1 the new position of the top right corner
    ...
    /**
     * Get the origin of the output com.jhlabs.image. Use this for working out where to draw your new com.jhlabs.image.
     * @return the X origin.
     */
