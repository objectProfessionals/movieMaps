...
/**
 * A filter which renders text onto an com.jhlabs.image.
 */
public class RenderTextFilter extends AbstractBufferedImageOp {
     ...
     * @param composite the com.jhlabs.composite (may be null)
	...
	/**
     * Set the com.jhlabs.composite with which to paint the text.
     * @param composite the com.jhlabs.composite
     * @see #getComposite
     */
	...
	/**
     * Get the com.jhlabs.composite with which to paint the text.
     * @return the com.jhlabs.composite
     * @see #setComposite
     */
