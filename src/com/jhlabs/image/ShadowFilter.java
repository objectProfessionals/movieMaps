...
/**
 * A filter which draws a drop shadow based on the alpha channel of the com.jhlabs.image.
 */
public class ShadowFilter extends AbstractBufferedImageOp {
	...
	/**
     * Set whether to increase the size of the output com.jhlabs.image to accomodate the shadow.
	...
	/**
     * Get whether to increase the size of the output com.jhlabs.image to accomodate the shadow.
	...
	/**
     * Set whether to only draw the shadow without the original com.jhlabs.image.
	...
	/**
     * Get whether to only draw the shadow without the original com.jhlabs.image.
    ...
    public BufferedImage filter( BufferedImage src, BufferedImage dst ) {
		...
		// Make a black mask from the com.jhlabs.image's alpha channel
        float[][] extractAlpha = {
            { 0, 0, 0, shadowR },
            { 0, 0, 0, shadowG },
            { 0, 0, 0, shadowB },
