...
public abstract class TransformFilter extends AbstractBufferedImageOp {
    ...
    /**
     * Clamp pixels to the com.jhlabs.image edges.
     */
    ...
    /**
     * Clamp pixels RGB to the com.jhlabs.image edges, but zero the alpha. This prevents gray borders on your com.jhlabs.image.
     */
    ...
    /**
     * The action to take for pixels off the com.jhlabs.image edge.
     */
    ...
    /**
     * The output com.jhlabs.image rectangle.
     */
	protected Rectangle transformedSpace;

    /**
     * The input com.jhlabs.image rectangle.
     */
	protected Rectangle originalSpace;

    /**
     * Set the action to perform for pixels off the edge of the com.jhlabs.image.
    ...
    /**
     * Get the action to perform for pixels off the edge of the com.jhlabs.image.
     ...
     * @param x the X position of the pixel in the output com.jhlabs.image
     * @param y the Y position of the pixel in the output com.jhlabs.image
     * @param out the position of the pixel in the input com.jhlabs.image
     */
	protected abstract void transformInverse(int x, int y, float[] out);

    /**
     * Forward transform a rectangle. Used to determine the size of the output com.jhlabs.image.
