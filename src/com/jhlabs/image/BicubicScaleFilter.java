...
/**
 * Scales an com.jhlabs.image using bi-cubic interpolation, which can't be done with AffineTransformOp.
 */
public class BicubicScaleFilter extends AbstractBufferedImageOp {
	...
	/**
	 * Constructor for a filter which scales the input com.jhlabs.image to the given width and height using bicubic interpolation.
	 * Unfortunately, it appears that bicubic actually looks worse than bilinear interpolation on most Java implementations,
	 * but you can be the judge.
     * @param width the width of the output com.jhlabs.image
     * @param height the height of the output com.jhlabs.image
	 */
